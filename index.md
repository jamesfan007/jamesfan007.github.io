...
具有人格的机器同样有独特性、稳定性、统合性、功能性；**不可复制和伪造**！    
具有人格的机器产生同样包含**制造**和**训练**两方面的结果。  
有人格的机器应当能够**在法律上代表主人**(拥有并使用该机器的主人)。同样具有姓名(设备的ID)、肖像(主人的人脸指纹等生物特征)、名誉(大家的对自己评价，包含诚信度、可信度)、**隐私**(不愿意让他人知道的信息)等要素；在网络世界的名誉(信誉)不可侮辱、诋毁；隐私不可侵犯；   
机器和人的最大区别是机器**没有感情**。**不会欺骗！**  
...[展开](./docs/20190322_humanmachine.html).
...
## 如何人人拥有并愿意使用Peer?
   ...
   很多人宁可等待形成了一个成熟的大市场后再跟进，去做微创新和降成本，而不愿意去创造一个新产品，开拓一个新市场。这事并无对错之分，只是站的角度不同。**这里并不是需要创造出一个叫"Peer"的新产品、新设备，而应该是在现有成熟市场的智能产品上，加入"Peer"功能。**  
   **IPC是一个大家有使用需求，成本足够低廉的Peer功能搭载落地平台**。正如将照相功能加入到手机李，最后挤掉照相机的低端市场一样。将Peer功能加入到IPC里面，就有可能排挤掉简单和低端的博客网站、自媒体网站以及个人电商平台。  
...
## 法律风险
**个人Peer本质上是实时加密通讯设备**。虽然法律保护通讯自由和通讯秘密，但不少国家同时也规定使用高强度加密设备通讯，必须获得政府许可和接受监管。监管意味着交出密钥，Peer就失去了意义。如何决解个人隐私权和政府监管权矛盾问题值得思考。
