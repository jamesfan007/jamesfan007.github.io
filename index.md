...
## 商业盈利模式
在开源开放的条件下，使用p2p的Peer，大家还能赚钱吗？有动力和资源去打造并维护这个p2p信息社会吗？<br/>芯片厂商，做方案，卖芯片。软件厂商...
  
## 现有互联网公司存在价值和发展方向
现有的互联网公司将转为网络基础服务商，不再直接拥有用户终端及其数据。  
可以向peer提供地址云储存、云计算、地址查询、数据转发等网络服务。  
也可以通过向Peer购买数据，用于市场分析、医学研究、AI训练等等大数据挖掘处理，再向peer提供搜索查询、买卖中介、研究咨询服务。...[展开](./docs/20190221_cloud.html).

## 现行法律风险及未来立法方向
大多数国家宪法都规定保护通讯自由和通讯秘密，但政府监管机关均有监管的要求。  
中国现行法律禁止使用未经报备的商用密码产品。 需要使用商用密码产品的，应当到商用密码产品销售许可单位购买。  
俄罗斯禁用加密即时通讯软件Telegram,原因是拒向官方提供密钥。  
但一旦向政府组织提供peer密钥，则存在泄露和滥用的可能，违背人人平等的理念。  
因此应该提供一个有效手段给监管机关：无法拦截查看信息内容本身或阻止其传播，但应该有技术手段追溯信息来源，可以在法院授权情况下，收缴Peer或在当事人配合下查看Peer。...[展开](./docs/20190221_law.html).
