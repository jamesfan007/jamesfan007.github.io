...
### Peer的产品形态
**Smart Phone is not Peer！** 符合个人终端peer产品定义的设备，大家想当然觉得就是手机。但手机的网络连接是间歇工作的，无法让别人通过网络随时访问自己的手机。电脑、电视、机顶盒、路由器、网络磁盘NAS，都由于各种原因，不是最佳的个人peer终端产品。  
...
## 商业盈利模式
#### 在开源开放的条件下，使用p2p的Peer，大家还能赚钱吗？有动力和资源去打造并维护这个p2p信息社会吗？芯片厂商，做方案，卖芯片；软件厂商,卖AI算法，卖数据分析工具；网络运营商，做中介，做服务...[展开](./docs/20190221_profit.html).
...
## 现行法律风险及未来立法方向
#### 大多数国家宪法都规定保护通讯自由和通讯秘密，但政府监管机关均有监管的要求。中国现行法律禁止使用未经报备的商用密码产品。 需要使用商用密码产品的，应当到商用密码产品销售许可单位购买。俄罗斯禁用加密即时通讯软件Telegram,原因是拒向官方提供密钥。但一旦向政府组织提供peer密钥，则存在泄露和滥用的可能，违背人人平等的理念。<br/> 因此应该提供一个有效手段给监管机关：无法拦截查看信息内容本身或阻止其传播，但应该有技术手段追溯信息来源，可以在Peer拥有者同意的状况下，对等地提供执法者的Peer身份认证，进行远程查询。确保隐私信息是明确地提供给谁，该执法者承担保密责任。也可以在法院授权情况下，现场收缴查看Peer。...[展开](./docs/20190221_law.html).
